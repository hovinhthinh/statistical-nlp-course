        ...
        if (this.getData() != null) {
            ...
            for (int k = 0; k < this.getData().length; k += 2) {
                ...
                for (int i = 0; i < this.getData()[k].length; i++) {
                    ...
                    g2.fillOval(transX - 3, transY - 3, size, size);
...
public class Simulator {
    ...
    public static void plotLongRangeDependency(float[] f, boolean center) {
        ...
        FastScatterPlotter plotter = new FastScatterPlotter("Long Range Dependency",
                "Distance", "Correlation value", data);
        plotter.plot(center);
    }

    public static void plotOOV(float[][] f, boolean center) {
        FastScatterPlotter plotter = new FastScatterPlotter("OOV",
                "Vocabuary size", "OOV-rate", f);
        plotter.plot(center);
